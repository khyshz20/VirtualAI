...
try {
  ...
  return (
    <div className='w-full h-[100vh] bg-no-repeat bg-cover bg-center flex justify-center items-center' style={{backgroundImage:`url(${bg})`}} >

      <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000036] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignUp}>
         <h1 className='text-white text-[30px] font-semibold'>Register to <span className='text-orange-500'>Virtuo</span> </h1>

         <h2 className='text-white text-[30px] font-semibold mb-[30px]'>Your Personal Virtual Assistant</h2>
         ...
         <button className='min-w-[150px] h-[60px] mt-[30px] bg-white rounded-full text-black font-semibold text-[19px]'disabled={loading}>{loading?"Loading...":"Sign Up"}
         </button>
